...
public class EmployeeService {
    ...
    public List<Employee> getAllEmployees() throws  EmployeeServiceException{
        try {
			...
			// TODO Auto-generated catch block
			throw new EmployeeServiceException("Service layer unable to fetch employee data",e);
		}
        finally {
    ...
    public int deleteEmployee(int id) throws EmployeeServiceException {
        try {
			...
			throw new EmployeeServiceException("Service layer unable to delete employee data",e);
		}finally {
    ...
    public int updateEmployee(Employee employee) throws  EmployeeServiceException {
        ...
        try {
			...
			throw new EmployeeServiceException("Service layer unable to update employee data",e.getCause());
		}finally {
